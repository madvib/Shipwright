...
import { GitCompareArrows, Circle, MessageSquare } from 'lucide-react'
        ...
        <>
          ...
          <div className="space-y-1">
            {gitLog.slice(0, 10).map((entry) => (
              <div key={entry.hash} onClick={() => onSelectCommit(entry.hash)} className="group cursor-pointer rounded-md px-2 py-2 -mx-1 hover:bg-muted/30 transition">
