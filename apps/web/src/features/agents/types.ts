...
export const DEMO_AGENT: AgentProfile = {
  ...
  version: 'v0.1.0',
  skills: [
    { id: 'ship-coordination', name: 'ship-coordination', content: '', version: 'v0.1.0', source: 'project' },
    { id: 'code-review', name: 'code-review', content: '', version: 'v1.0.0', source: 'registry' },
    { id: 'debug-expert', name: 'debug-expert', content: '', version: 'v1.0.0', source: 'registry' },
    { id: 'frontend-design', name: 'frontend-design', content: '', version: 'v0.2.0', source: 'project' },
    { id: 'vercel-react', name: 'vercel-react', content: '', version: 'v1.0.0', source: 'registry' },
  ],
  mcpServers: [
    { name: 'ship', command: 'ship', args: ['mcp', 'serve'], server_type: 'stdio' },
    { name: 'github', command: 'npx', args: ['-y', '@modelcontextprotocol/server-github'], server_type: 'stdio' },
    { name: 'filesystem', command: 'npx', args: ['-y', '@modelcontextprotocol/server-filesystem', '.'], server_type: 'stdio' },
  ],
  subagents: [
