        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <span className="text-[10px] font-mono text-muted-foreground/40">{skill.skillId}</span>
            </div>
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              {skill.description}
            </p>
            <div className="flex items-center gap-3 mt-1.5">
              <span className="text-[10px] font-mono text-muted-foreground/30 truncate max-w-[120px]" title={skill.contentHash}>
