...
CREATE TABLE IF NOT EXISTS events (
  ...
  event_type       TEXT NOT NULL,              -- 'session.started'
  entity_id        TEXT NOT NULL,              -- aggregate ID
  actor            TEXT NOT NULL DEFAULT 'ship',
  payload_json     TEXT NOT NULL DEFAULT '{}',
  ...
  workspace_id     TEXT,
  session_id       TEXT,
  actor_id         TEXT,                      -- emitting actor ULID
  parent_actor_id  TEXT,                      -- supervisor actor ULID
  elevated         INTEGER NOT NULL DEFAULT 0, -- 1 = bubbled to parent log
  created_at       TEXT NOT NULL DEFAULT (datetime('now'))
);
