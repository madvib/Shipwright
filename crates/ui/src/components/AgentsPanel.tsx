...
import { DEFAULT_STATUSES, McpServerConfig, ModeConfig, ProjectConfig } from '../types';
import { exportAgentConfigCmd, generateIssueDescriptionCmd } from '../platform/tauri/commands';
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updateActiveAgentConfig({
                      ...activeAgentConfig,
                      ai: { ...(activeAgentConfig.ai ?? {}), provider: value },
                    })
                  }
                >
